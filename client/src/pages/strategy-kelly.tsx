          ...
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className="text-sm"
                onClick={() => {
                  const ok = betting.loadLatestSession('kelly');
                  if (!ok) {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            {/* Sessioni Salvate */}
            {Array.isArray(betting.sessions) && betting.sessions.filter((session: any) => session.strategy === 'kelly').length > 0 && (
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-medium">Sessioni Kelly Salvate</h3>
                    <div className="text-sm text-gray-500">
                      {betting.sessions.filter((session: any) => session.strategy === 'kelly').length} sessioni trovate
                    </div>
                  </div>

                  <div className="space-y-3">
                    {betting.sessions
                      .filter((session: any) => session.strategy === 'kelly')
                      .map((session: any) => (
                          ...
                          <div className="flex space-x-2 ml-4">
                            <Button
                              ...
                              onClick={() => {
                                ...
                                setKellyFraction((settings.kellyFraction || 0.25) * 100);
                                setMaxRiskPercentage((settings.maxRiskPercentage || 0.20) * 100);
                                setMaxSingleStake(settings.maxSingleStake || 100);
